...
import kotlinx.android.synthetic.main.activity_ks5_bs_no.*

class Ks5BsNoActivity : AppCompatActivity() {

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_ks5_bs_no)
    ...
    fun btnhesabla5no(view: View) {
        try {
            ...
            if ((!TextUtils.isEmpty(this.kqs1.getText().toString()))  && (!TextUtils.isEmpty(this.kqs2.getText().toString())) &&
                ...
                && (!TextUtils.isEmpty(this.kqs5.getText().toString()))) {
                ...
                if ((ksq1 <= 100.0F) && (ksq1 >= 0.0F) && (ksq2 <= 100.0F) && (ksq2 >= 0.0F) && (ksq3 <= 100.0F)
                    ...
                    var cvb1 = ((ksq1 + ksq2 + ksq3 +ksq4 +ksq5) / 5)
